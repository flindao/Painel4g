...
mkdir /var/www/html
cd /var/www/html
wget https://raw.githubusercontent.com/flindao/painel/main/multipanel/panel_v10_2/painel10.zip > /dev/null 2>&1
sleep 1
...
sleep 1
cd
wget https://raw.githubusercontent.com/flindao/painel/main/multipanel/panel_v10_2/ssh.sql > /dev/null 2>&1
sleep 1
...
echo -e "\033[1;37mwget https://raw.githubusercontent.com/flindao/painel/main/multipanel/panel_v10/revenda/confpainel/inst && bash inst\033[0m"
