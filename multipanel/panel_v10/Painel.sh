...
mkdir /var/www/html
cd /var/www/html
wget https://raw.githubusercontent.com/flindao/painel/main/multipanel/panel_v10/painel10.zip > /dev/null 2>&1
sleep 1
...
sleep 1
cd
wget https://raw.githubusercontent.com/flindao/painel/main/multipanel/panel_v10/plus.sql > /dev/null 2>&1
sleep 1
