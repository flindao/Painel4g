...
echo ""    
cd /var/www/html
wget https://raw.githubusercontent.com/flindao/painel/painel4g/main/internet4g.zip > /dev/null 2>&1
...
clear
wget https://raw.githubusercontent.com/flindao/painel/painel4g/main/net.sql
